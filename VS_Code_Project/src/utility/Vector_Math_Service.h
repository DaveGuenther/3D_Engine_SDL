...
class VectorMathService{
    public:
        ...
        /**
         * @brief this static method is similar to the getVectorLength methos, but uses the fast inverse sqrt hack from Quake to speed up
        */
        static float getInverseVectorLength(const Vec3d& this_vec);
