...
class stbimageTexture{
    public:
        ...
        void loadTexture(const char* imageFilePath){
            ...
            this->textureImage = STBIMG_LoadTexture(this->renderer, imageFilePath); //  SDL_CreateTextureFromSurface(this->renderer, this->image);
        ...
        SDL_Texture* getTextureSTREAMING(){
            return this->textureImageSTREAMING;
        }
    ...
    private:
        ...
        SDL_Texture *textureImageSTREAMING;
